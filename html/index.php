      ...
      <header>
       ...
       <ul class=loginandcart>
         ...
         <li><a href="logout.php">logout</a></li>
          <li><a href="./shop.php?view_cart=1">Cart</a></li>
       </ul>
      </header>
      <div id="main">
        <div id="featureditems">
          <div id="featured">
            ...
            <div class="info">
               <h1>feature</h1>
                <p>
                   Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at volutpat dui, ut dapibus orci. Quisque nec pellentesque massa. Mauris suscipit elementum ipsum, et vehicula orci sollicitudin id. Aenean egestas, leo ac hendrerit lacinia, velit sapien accumsan odio, vel consequat augue tellus sit amet nibh. Aliquam euismod sollicitudin dui et suscipit. Suspendisse at malesuada turpis. 
               </p>
           </div> 
       </div>
      </div>
